...
@OpenAPIDefinition(info = @Info(title = "Salve", version = "1.0", description = "API do salve food amém", contact = @Contact(name = "Bernardo", email = "bernardogomesrib@gmail.com", url = "https://naotenhosite.com/"), license = @License(name = "Licence name", url = "https://some-url.com"), termsOfService = "Terms of service"), servers = {
